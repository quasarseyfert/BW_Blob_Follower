...
class EmergencyStop:
	def __init__(self):
		...
		self.pub_stop_func = rospy.Publisher("/racecar/ackermann_cmd_mux/input/safety", AckermannDriveStamped, queue_size=5) #Overrides any other command to the input/navigation topic
	...
	def LidarScanReceived(self, msg):
		...
		if (min(msg.ranges[720:760]) < 1.5):	#If the mininimum of the distances to the nearest object for all angles measured between the array locations 520 and 560 is less than 1.5, stop moving.	
