...
def pdi_callback(msg):
    kp=.5
    kd=.05
    #side = msg.ranges[148:213]  # right
    side = msg.ranges[868:933]  # left
    #mult = 1  # right
    mult = -1 # left
...
pdi_pub = rospy.Publisher("vesc/ackermann_cmd_mux/input/navigation", AckermannDriveStamped, queue_size=0)
scan_sub = rospy.Subscriber("scan", LaserScan, pdi_callback)
